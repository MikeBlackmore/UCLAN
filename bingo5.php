...
<html xml:lang="en" xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		<title>Practical 6 - BINGO5</title>
	...
	<body>
		...
		while ($counter <=90)
			{
			$usednumbers[$counter]=$counter;
			$counter=$counter+1;
			}
		// use shuffle to randomize the array elements NB: This puts one number in element 0.
		shuffle($usednumbers);		
		...
		while($ballsdrawn <=89)
			{
			echo "ball number $ballsdrawn is $usednumbers[$ballsdrawn]<br />";
			$ballsdrawn++;
			$tries++;
			}
		//finally, show the number stored in element 0	
		echo "ball number $ballsdrawn is $usednumbers[0]<br />";
